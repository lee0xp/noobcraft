...
import de.lee0xp.client.gui.GuiMainScreen;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
	...
	public GuiMainMenu()
	{
		...
		this.splashText = "Couldn't load splashes!";
	...
	{
		if (!force)mc.displayGuiScreen(new GuiMainScreen());
		if (this.panoramaTimer == 0)
			this.panoramaTimer = 2;
		this.panoramaTimer = this.panoramaTimer * 2;
		this.splashText = "Congratulations, you found the secret screen!";
		...
		for (int var7 = 0; var7 < var6 * var6; ++var7)
		{
			...
			for (int var11 = 0; var11 < 6; ++var11)
			{
				...
				*/
				...
				//this.mc.getTextureManager().bindTexture(titlePanoramaPaths[0]);
