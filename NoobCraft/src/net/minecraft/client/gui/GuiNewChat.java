					...
					if (var10 != null)
					{
						...
						if (var11 < 200 || var3)
						{
							...
							if (var14 > 3)
							{
								...
								//this.mc.fontRendererObj.func_175063_a("§8[§eC§8]§f " + var17, (float) var15, (float) (var16 - 8), 16777215 + (var14 << 24));
							    Client.getInstance().fontrender.func_175063_a(var17, (float) var15, (float) (var16 - 11), 16777215 + (var14 << 24));
