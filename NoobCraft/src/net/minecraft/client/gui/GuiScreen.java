...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(this.fontRendererObj, (Vars.debug ? "§cYou are running in Debug mode!" : ""), this.width / 2, this.height - 13, 8421504);
        this.drawCenteredString(this.fontRendererObj, (Vars.debug ? "§cYou are running in Debug mode!" : ""), this.width / 2, 5, 8421504);
     ...
     */
    /*XXX */protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        if (mouseButton == 0)
        {
     ...
     */
    /*XXX*/public void drawBackground(int tint)
    {
       drawBackground(tint, "textures/gui/options_background.png");
    }
    
    public void drawBackground(int tint, String loc)
    {
        GlStateManager.disableLighting();
        GlStateManager.disableFog();
        Tessellator var2 = Tessellator.getInstance();
        WorldRenderer var3 = var2.getWorldRenderer();
        this.mc.getTextureManager().bindTexture(new ResourceLocation(loc));
