...
import de.lee0xp.client.gui.IAction;
...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
	...
	public void createButtons()
	{
		...
		this.buttonList.add(new GuiButton(72, this.width / 2 + 4 + 76, 5, 75, 20, "Change name"));
	...
	protected void actionPerformed(GuiButton button) throws IOException
	{
		if (button.enabled)
		{
			...
			{
				Alert.inputBox("§eEnter a new Username (cracked)", "§4§lUsername changer", Minecraft.getMinecraft().getSession().getUsername(), this, new IAction()
				{
					...
					public void actionPerformed()
					{
						if (getText().isEmpty())
						{
							Alert.alert("§4§lError", GuiMultiplayer.this, false, "§eThe username may not be empty!");
							return;
						}else{
							Minecraft.getMinecraft().getSession().setUsername(getText());
