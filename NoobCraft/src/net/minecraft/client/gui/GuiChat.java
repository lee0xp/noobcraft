...
import de.lee0xp.client.hackutil.ChatCommands;
...
public class GuiChat extends GuiScreen
{
    ...
    public void updateScreen()
    {
     ...
     //   if (!this.inputField.getText().startsWith("§a+§f")) this.inputField.setText("§a+§f" + this.inputField.getText().replace("§a+§f", ""));
    }
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException
    {
        ...
        {
            String var3 = this.inputField.getText().trim();//.replace("§a+§f", "");
            
            if (ChatCommands.parse(var3))
            {	
            	return; 
            }
            if (var3.length() > 0)
    ...
    private void sendAutocompleteRequest(String p_146405_1_, String p_146405_2_)
    {
    	...
    	//if (p_146405_1_.startsWith("§a+§f")) p_146405_1_ = p_146405_1_.replace("§a+§f", "");
