...
import de.lee0xp.client.gui.GuiClientSettings;
...
public class GuiIngameMenu extends GuiScreen
{
    ...
    //    var3.enabled = this.mc.isSingleplayer() && !this.mc.getIntegratedServer().getPublic();
        ...
        this.buttonList.add(new GuiButton(100, this.width / 2 - 100, this.height / 4 + var1, "§eClient settings"));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        switch (button.id)
        {
            ...
            case 7:
                ...
                break;
            case 100:
            	Minecraft.getMinecraft().displayGuiScreen(new GuiClientSettings(this));
            	break;
        }
    }
    ...
    {
    	if (!showButton){
    		GuiButton gb = (GuiButton) this.buttonList.get(this.buttonList.size() - 1);
    		gb.visible = false;
    	}
