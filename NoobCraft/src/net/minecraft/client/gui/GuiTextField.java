...
public class GuiTextField extends Gui
{
    ...
    {
    	if (this.text.equals("§a+§f")) return;
        if (this.text.length() != 0)
        {
            if (this.selectionEnd != this.cursorPosition)
            {
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            Client.getInstance().fontrender.func_175063_a(var10, (float)var7, (float)var8 - 2, var1);
                var9 = this.xPosition +  Client.getInstance().fontrender.getStringWidth(var10);
            }
            ...
            if (var6)
            {
                ...
                {
                    this.fontRendererInstance.func_175063_a("_", (float)var11, (float)var8 + 1, var1);
                }
            }
