...
public class Gui
{
    ...
    {
        fontRendererIn.func_175063_a(Credits.parse(text), (float)(x - fontRendererIn.getStringWidth(text) / 2), (float)y, color);
    }
    ...
    {
    	fontRendererIn.func_175063_a(Credits.parse(text), (float)x, (float)y, color);
    }
