...
import de.lee0xp.client.gui.CustomGuiIngame;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
	...
	public static final List macDisplayModes = Lists.newArrayList(new DisplayMode[]
	...
	public void startGame() throws LWJGLException
	{
		...
		this.setRenderEngine(new TextureManager(this.mcResourceManager));
		this.mcResourceManager.registerReloadListener(this.getRenderEngine());
		this.func_180510_a(this.getRenderEngine());
		this.func_175595_al();
		...
		//this.fontRendererObj = new UnicodeFontRenderer(new Font("Trebuchet MS", Font.PLAIN, 15));
		...
		this.getRenderEngine().loadTickableTexture(TextureMap.locationBlocksTexture, this.textureMapBlocks);
		this.getRenderEngine().bindTexture(TextureMap.locationBlocksTexture);
		this.textureMapBlocks.func_174937_a(false, this.gameSettings.mipmapLevels > 0);
		this.modelManager = new ModelManager(this.textureMapBlocks);
		this.mcResourceManager.registerReloadListener(this.modelManager);
		this.renderItem = new RenderItem(this.getRenderEngine(), this.modelManager);
		this.renderManager = new RenderManager(this.getRenderEngine(), this.renderItem);
		...
		this.effectRenderer = new EffectRenderer(this.theWorld, this.getRenderEngine());
		this.checkGLError("Post startup");
		
		client = new Client();
		//this.ingameGUI = new GuiIngame(this);
		this.ingameGUI = new CustomGuiIngame(this);
		...
		if (var1 != Util.EnumOS.OSX)
		{
			...
			try
			{
				...
				if (var2 != null && var3 != null)
				{
					...
					{ this.readImageToBuffer(var2), this.readImageToBuffer(var3) });
				}
	...
	public static void test()
	{
		...
		frame.setTitle("Minecraft crash report - NoobCraft 1.8 - coded by lee0xp");
		JTextArea jta = new JTextArea();
		JScrollPane sp = new JScrollPane(jta);
		//jta.setText(FileUtils.readFileToString(new File("C:\\Users\\Lee\\Desktop\\test.txt")));
	...
	public void displayCrashReport(CrashReport crashReportIn)
	{
		...
		String crashReport = crashReportIn.getCompleteReport();
		
		jta.setText(crashReport);
		jta.setFont(new Font("Consolas", Font.PLAIN, 12));
		jta.setEditable(false);
		frame.getContentPane().add(sp);
		...
		{
			Bootstrap.print("#@!@# Game crashed! Crash report saved to: #@!@# " + var3.getAbsolutePath());
			//System.exit(-1);
		} else
		{
		...
		{
			jta.append("\n\nAdditionally Nimbus L&F not found!");
		} 
	
		if (crashReport.contains("at ClientDebugger.main")){
			crashReport = "##### NOTICE: You are running in a deobfuscated environment (propably the client is started trough eclipse) #####\n\n\n" + crashReport;
			jta.setText(crashReport);
			return;
 		}
		
		if (crashReport.contains("de.lee0xp.client"))
		{
			new JOptionPane().showMessageDialog(null, "The crash report indicates that the error came from the Hackclient itself, you can contact the creator: lee@lee0xp.de", "Warning!", 0);
	...
	public void scaledTessellator(int width, int height, int width2, int height2, int stdTextureWidth, int stdTextureHeight)
	{
		...
		var9.addVertexWithUV((double) (width + stdTextureWidth), (double) (height + stdTextureHeight), 0.0D, (double) ((float) (width2 + stdTextureWidth) * var7),
	...
	public void runGameLoop() throws IOException
	{
		...
		while (getSystemTime() >= this.debugUpdateTime + 1000L)
		{
			...
			{ Integer.valueOf(debugFPS), Integer.valueOf(RenderChunk.field_178592_a), RenderChunk.field_178592_a != 1 ? "s" : "",
					...
					this.gameSettings.enableVsync ? " vsync" : "", this.gameSettings.fancyGraphics ? "" : " fast", this.gameSettings.clouds ? " clouds" : "",
	...
	public void displayDebugInfo(long elapsedTicksTime)
	{
		if (this.mcProfiler.profilingEnabled)
		{
			...
			this.fontRendererObj.func_175063_a(var20 = var19.format(var4.field_76330_b) + "%", (float) (var8 + var7 - this.fontRendererObj.getStringWidth(var20)), (float) (var9 - var7 / 2 - 16),
					var14);
			...
			for (int var21 = 0; var21 < var3.size(); ++var21)
			{
				...
				this.fontRendererObj.func_175063_a(var23 = var19.format(var22.field_76332_a) + "%", (float) (var8 + var7 - 50 - this.fontRendererObj.getStringWidth(var23)), (float) (var9 + var7 / 2
						+ var21 * 8 + 20), var22.func_76329_a());
				this.fontRendererObj.func_175063_a(var23 = var19.format(var22.field_76330_b) + "%", (float) (var8 + var7 - this.fontRendererObj.getStringWidth(var23)), (float) (var9 + var7 / 2
						+ var21 * 8 + 20), var22.func_76329_a());
			}
		}
	}
	...
	public void launchIntegratedServer(String folderName, String worldName, WorldSettings worldSettingsIn)
	{
		...
		this.loadingScreen.displaySavingString("Loading....");
	...
	public CrashReport addGraphicsAndWorldToCrashReport(CrashReport theCrash)
	{
		...
		theCrash.getCategory().addCrashSectionCallable("Is Modded", new Callable()
		{
			...
			public String call()
			{
				...
				return !var1.equals("vanilla") ? "Definitely; Client brand changed to \'" + var1 + "\'" : (Minecraft.class.getSigners() == null ? "Very likely; Jar signature invalidated"
	...
	public MusicTicker.MusicType getAmbientMusicType()
	{
		return this.currentScreen instanceof GuiWinGame ? MusicTicker.MusicType.CREDITS
				: (this.thePlayer != null ? (this.thePlayer.worldObj.provider instanceof WorldProviderHell ? MusicTicker.MusicType.NETHER
						: (this.thePlayer.worldObj.provider instanceof WorldProviderEnd ? (BossStatus.bossName != null && BossStatus.statusBarTime > 0 ? MusicTicker.MusicType.END_BOSS
								: MusicTicker.MusicType.END) : (this.thePlayer.capabilities.isCreativeMode && this.thePlayer.capabilities.allowFlying ? MusicTicker.MusicType.CREATIVE
	...
	public void setSession(Session authSession)
	{
