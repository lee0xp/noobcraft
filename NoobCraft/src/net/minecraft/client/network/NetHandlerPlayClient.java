...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleEntityVelocity(S12PacketEntityVelocity packetIn)
    {
        ...
        if (var2 != null && !Client.INSTANCE.mm.noKnockback.isEnabled())
        {
    ...
    public void handleChat(S02PacketChat packetIn)
    {
        ...
        {
            this.gameController.ingameGUI.setRecordPlaying(packetIn.func_148915_c().getFormattedText(), false);
        }
        else
        {
    ...
    public void func_175099_a(S45PacketTitle p_175099_1_)
    {
        ...
        switch (NetHandlerPlayClient.SwitchAction.field_178885_a[var2.ordinal()])
        {
            ...
            case 3:
               ...
               // this.gameController.ingameGUI.unknown1();
                return;
        }
